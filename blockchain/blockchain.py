...
class Blockchain:
    ...
    def submit_transaction(self, sender_public_key, sender_pan_key, recipient_public_key,recipient_pan_key, signature, amount):
        transaction = OrderedDict({
            'sender_public_key': sender_public_key,
            'sender_pan_key': sender_pan_key,
            'recipient_public_key': recipient_public_key,
            'recipient_pan_key': recipient_pan_key,
            'amount': amount
        })
    ...
    def valid_chain(self, given_chain):
        ...
        while current_index < len(given_chain):
            ...
            transaction_elements = ['sender_public_key','sender_pan_key'
                                    'recipient_public_key','recipient_pan_key',
                                    'amount']
...
def mine():
    ...
    blockchain.submit_transaction(sender_public_key=MINING_SENDER,
                                  sender_pan_key=Mine_sender_pan_key,
                                  recipient_public_key=blockchain.node_id,
                                  recipient_pan_key=Mine_recipient_pan_key,
                                  signature='',
...
def transaction_new():
    values = request.form
    required = ['confirmation_sender_public_key','confirmation_sender_pan_key', 'confirmation_recipient_public_key','confirmation_recipient_pan_key',
    ...
    transaction_results = blockchain.submit_transaction(values['confirmation_sender_public_key'],
                                                        values['confirmation_sender_pan_key'],
                                                        values['confirmation_recipient_public_key'],
                                                        values['confirmation_recipient_pan_key'],
